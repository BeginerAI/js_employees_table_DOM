...
function sortTable(tH) {
    ...
    else sortDirection[columnName] = sortDirection[columnName] === "asc" ? "desc" : "asc";
    const direction = sortDirection[columnName];
    const rows = [
        ...tBody.querySelectorAll("tr")
    ];
    rows.sort((sortA, sortB)=>{
        const cellA = sortA.children[columnIndex].innerText.trim().replace(/[$,]/g, "");
        const cellB = sortB.children[columnIndex].innerText.trim().replace(/[$,]/g, "");
        const isNumber = !isNaN(cellA) && !isNaN(cellB);
        if (isNumber) return direction === "asc" ? parseFloat(cellA) - parseFloat(cellB) : parseFloat(cellB) - parseFloat(cellA);
        else return direction === "asc" ? cellA.localeCompare(cellB) : cellB.localeCompare(cellA);
    });
    tBody.innerHTML = "";
...
tBody.addEventListener("dblclick", (e)=>{
    ...
    input.addEventListener("blur", ()=>{
        ...
        if (newValue !== originalText && newValue !== "") cell.textContent = newValue;
        else cell.textContent = originalText;
    });
    input.addEventListener("keydown", (y)=>{
        if (y.key === "Enter") input.blur();
    });
});
form.addEventListener("submit", (e)=>{
    ...
    if (nameId === "" || !isNaN(nameId)) pushNotification(300, 10, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430!", "\u0411\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u0432\u0432\u0435\u0434\u0456\u0442\u044C \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u0435 \u0456\u043C\u2019\u044F!", "error");
    // Перевірка для positionId
    if (positionId === "" || !isNaN(positionId)) setTimeout(()=>{
        pushNotification(400, 10, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430!", "\u0411\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u0432\u0432\u0435\u0434\u0456\u0442\u044C \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u0443 \u043F\u043E\u0441\u0430\u0434\u0443", "error");
    }, 300);
    // Перевірка для officeId
    if (!officeId) setTimeout(()=>{
        pushNotification(500, 10, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430!", "\u0411\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u0432\u0432\u0435\u0434\u0456\u0442\u044C \u0432\u0430\u0448 \u043E\u0444\u0456\u0441", "error");
    }, 600);
    // Перевірка для ageId
    if (isNaN(parseFloat(ageId)) || parseFloat(ageId) < 18 || parseFloat(ageId) > 90) setTimeout(()=>{
        pushNotification(600, 10, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430!", "\u0411\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u0432\u0432\u0435\u0434\u0456\u0442\u044C \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u0438\u0439 \u0432\u0456\u043A \u0432\u0456\u0434 18 \u0434\u043E 90!", "error");
    }, 800);
    // Перевірка для salaryId
    if (!parseFloat(salaryId) || isNaN(parseFloat(salaryId))) setTimeout(()=>{
        pushNotification(700, 10, "\u041F\u043E\u043C\u0438\u043B\u043A\u0430!", "\u0411\u0443\u0434\u044C \u043B\u0430\u0441\u043A\u0430, \u0432\u0432\u0435\u0434\u0456\u0442\u044C \u043F\u0440\u0430\u0432\u0438\u043B\u044C\u043D\u0443 \u0437\u0430\u0440\u043F\u043B\u0430\u0442\u0443 ", "error");
    }, 1000);
    else {
        setTimeout(()=>{
            pushNotification(500, 10, "\u0412 \u0442\u0430\u0431\u043B\u0438\u0446\u044E \u0434\u043E\u0434\u0434\u0430\u043D\u043E \u043D\u043E\u0432\u0435 \u043F\u043E\u043B\u0435", "\u0412 \u0442\u0430\u0431\u043B\u0438\u0446\u0456 \u0437\u044F\u0432\u0438\u0432\u0441\u044F \u043D\u043E\u0432\u0438\u0439 \u0440\u044F\u0434\u043E\u043A \u0437 \u0432\u043A\u0430\u0437\u0430\u043D\u0438\u043C\u0438 \u0434\u0430\u043D\u0438\u043C\u0438", "success");
        }, 1000);
